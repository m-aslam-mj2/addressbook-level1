...
* `add John Doe p/98765432 e/johnd@gmail.com a/Singapre`
* `add Betsy Crowe e/bencrowe@gmail.com p/1234567 a/Singapore`
...
Finds persons that match given keywords (case-insensitive).+
